    ...
    build: {
      rollupOptions: {
        input: {
          ...
          elevage: path.resolve(__dirname, 'pages/shared/elevage.html'),
          discussion: path.resolve(__dirname, 'pages/shared/discussion.html'),
          calendar: path.resolve(__dirname, 'pages/shared/calendar.html'),
          training: path.resolve(__dirname, 'pages/shared/training.html'),
