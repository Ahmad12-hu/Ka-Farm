...
export const App = {
  ...
  injectSidebar() {
    ...
    const sidebarHTML = `
      <aside id="sidebar" class="w-64 flex-shrink-0 bg-[#06130B] dark:bg-[#06130B] text-slate-300 flex flex-col border-r border-[#143E23] z-40 lg:sticky lg:top-0 lg:h-screen transition-all duration-300 fixed inset-y-0 left-0 transform -translate-x-full lg:translate-x-0 lg:transform-none">
        ...
        <div class="p-5 border-b border-[#143E23] flex items-center justify-between">
          <a href="/index.html" class="flex items-center gap-3 text-left hover:opacity-90 transition-opacity">
            ...
            <div>
              ...
              <p class="text-[10px] text-[#819888] font-bold">Maraîchage & Horticulture 🇸🇳</p>
            </div>
          </a>
  ...
  injectFooter() {
    ...
    if (mainEl && !document.getElementById('app-global-footer')) {
      ...
      footer.className = 'mt-12 py-6 border-t border-slate-100 dark:border-[#143E23]/20 text-center text-[11px] text-slate-400 dark:text-[#5F8369] font-medium w-full';
      footer.innerHTML = `
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 max-w-7xl mx-auto px-4">
          ...
          <div class="flex items-center gap-2 bg-slate-50 dark:bg-[#051108] border border-slate-150 dark:border-[#143E23]/20 px-3 py-1.5 rounded-full">
