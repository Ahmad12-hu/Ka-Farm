...
export const Router = {
  ...
  publicRoutes: new Set(["/", "/index.html", "/pages/auth/login.html", "/pages/auth/signup.html"]),
  ...
  adminPublicRoutes: new Set(["/pages/admin/login.html"]),

  adminRoutes: new Set(["/pages/admin/dashboard.html"]),
