...
const DEFAULT_CHEPTEL = [
  ...
  {
    id: "CH-003",
    name: "Poules Pondeuses Cobb 500",
    type: "Volailles",
    breed: "Cobb 500",
    quantity: 350,
    unit: "sujets",
...
const DEFAULT_ELEVAGE_PRODUCTION = [
  {
    ...
    quantity: 145,
    unit: "L",
    notes: "Excellente traite matinale, lait collecté par le GIE laiterie.",
  },
  {
    id: "PROD-002",
    date: "2026-06-25",
...
const DEFAULT_ELEVAGE_HEALTH = [
  {
    ...
    practitioner: "Dr. Diop (Vétérinaire)",
    cost: 15000,
    notes: "Rappel annuel effectué pour tout le troupeau.",
  },
  {
    id: "HEA-002",
    date: "2026-06-18",
    target: "Génisses Laitières",
    intervention: "Déparasitage systématique",
    practitioner: "Samba Sow (Interne)",
    cost: 8000,
    notes: "Administration orale de vermifuge.",
  },
];
