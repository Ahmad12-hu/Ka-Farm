...
const DEFAULT_PARCELLES = [
  ...
  },
  {
    ...
    status: "Cultivée",
    type_sol: "limoneux",
    history: ["Oignon Rouge de Galmi", "Piment Oiseau", "Arachide"],
    currentCrop: "Oignon Rouge de Galmi",
    waterStatus: "Besoin d'eau",
  },
  {
    id: "P-003",
    name: "Parcelle Sud - Planche 1",
    surface: 150,
    lat: 14.7924,
    lng: -17.2659,
    status: "Cultivée",
    type_sol: "argileux",
    history: ["Chou Cabus", "Aubergine", "Jachère"],
    currentCrop: "Chou Cabus",
    waterStatus: "Irrigué",
  },
  {
    id: "P-004",
    name: "Zone Ombragée - Bac A",
    surface: 50,
    lat: 14.7935,
    lng: -17.2662,
    status: "Cultivée",
    type_sol: "sableux",
    history: ["Menthe de Thiès", "Laitue de saison"],
    currentCrop: "Menthe de Thiès",
    waterStatus: "Irrigué",
  },
  {
    id: "P-005",
    name: "Parcelle Ouest - Verger",
    surface: 800,
    lat: 14.7928,
    lng: -17.2648,
    status: "En préparation",
    type_sol: "limoneux",
    history: ["Papayer Solo", "Gombo d'hivernage"],
    currentCrop: "Papayer Solo (Jeunes plants)",
    waterStatus: "Besoin d'eau",
  },
];
