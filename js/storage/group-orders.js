...
const DEFAULT_FARMS_COMMUNITY = [
  {
    ...
    region: 'Niayes',
    contact_name: 'Responsable terrain',
    contact_phone: '77 123 45 67',
    contact_email: 'terrain@kafarm.sn',
  ...
  },
  {
    ...
    region: 'Thiès',
    contact_name: 'Responsable bureau',
    contact_phone: '76 456 78 90',
    contact_email: 'bureau@agri.sn',
...
const DEFAULT_GROUP_ORDERS = [
  {
    ...
    initiated_by: 'Responsable terrain',
    supplier_id: 'SUP-001',
  ...
  },
  {
    ...
    initiated_by: 'Responsable bureau',
    supplier_id: 'SUP-002',
