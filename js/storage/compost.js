...
const DEFAULT_COMPOST_MATERIALS = [
  {
    ...
    unit: "kg",
    description:
      "Fumier de vache fraîchement produit. Riche en azote et matière organique. Nécessite un compostage prolongé.",
    is_common_in_senegal: true,
    notes:
      "Disponible localement dans les fermes d'élevage. Peut contenir des graines de mauvaises herbes.",
  },
  {
    id: "CM-002",
  ...
  },
  {
    ...
    unit: "kg",
    description:
      "Fientes de volaille très riches en azote et phosphore. À utiliser avec précaution (risque de brûlures).",
    is_common_in_senegal: true,
...
const DEFAULT_MAIN = [
  {
    ...
    description:
      "Recette traditionnelle en couches alternées de matériaux verts et bruns. Idéale pour les débutants.",
    target_c_n_ratio: 30,
    ideal_moisture: 60,
  ...
  },
  {
    ...
    description:
      "Recette optimisée pour une décomposition rapide. Parfaite pour les cultures intensives.",
    target_c_n_ratio: 25,
    ideal_moisture: 65,
...
const DEFAULT_RECIPE_INGREDIENTS = [
  ...
  },
  {
    ...
    unit: "kg",
    proportion_percent: 30,
    notes: "Fumier de mouton - riche en azote",
  },
  {
    id: "RI-007",
    recipe_id: "CR-002",
    ...
    quantity: 40,
    unit: "kg",
    proportion_percent: 20,
    notes: "Feuilles sèches - carbone",
  },
  {
    id: "RI-008",
    recipe_id: "CR-002",
    ...
    quantity: 50,
    unit: "kg",
    proportion_percent: 25,
    notes: "Mauvaises herbes - azote",
  },
  {
    id: "RI-009",
    recipe_id: "CR-002",
  ...
  },
  {
    ...
    quantity: 20,
    unit: "kg",
    proportion_percent: 10,
    notes: "Tourteau d'arachide - azote",
  },
  {
    id: "RI-014",
    recipe_id: "CR-003",
    ...
    quantity: 10,
    unit: "kg",
    proportion_percent: 5,
    notes: "Cendres - potassium",
  },
  {
    id: "RI-015",
    recipe_id: "CR-003",
  ...
  },
  {
    ...
    quantity: 100,
    unit: "kg",
    proportion_percent: 50,
    notes: "Fumier de mouton - base",
  },
  {
    id: "RI-017",
    recipe_id: "CR-004",
  ...
  },
  {
    ...
    unit: "kg",
    proportion_percent: 15,
    notes: "Fientes de poulet - azote concentré",
  },
  {
    id: "RI-020",
    recipe_id: "CR-005",
    ...
    unit: "kg",
    proportion_percent: 30,
    notes: "Mauvaises herbes - matière verte",
  },
  {
    id: "RI-021",
    recipe_id: "CR-005",
  ...
  },
  {
    ...
    unit: "kg",
    proportion_percent: 20,
    notes: "Épluchures - activation microbienne",
  },
  {
    id: "RI-023",
    recipe_id: "CR-005",
...
const DEFAULT_COMPOST_HISTORY = [
  {
    ...
    status: "Terminé",
    notes:
      "Premier tas de compost de la saison. Bonne décomposition. Utilisé sur la parcelle des tomates.",
  },
  {
    id: "CH-002",
    recipe_id: "CR-002",
...
export const CompostStorage = {
  ...
  calculateIdealMix(targetRatio = 30) {
    const materials = this.getCompostMaterials();
    const greens = materials.filter(
      (m) =>
        m.material_type === "Fumier" ||
        m.material_type === "Résidus verts" ||
        m.material_type === "Déchets de cuisine"
    );
    const browns = materials.filter(
      (m) => m.material_type === "Résidus végétaux" || m.material_type === "Sous-produit agricole"
    );

    const avgGreenRatio =
      greens.length > 0 ? greens.reduce((sum, m) => sum + m.c_n_ratio, 0) / greens.length : 15;
    const avgBrownRatio =
      browns.length > 0 ? browns.reduce((sum, m) => sum + m.c_n_ratio, 0) / browns.length : 40;
  ...
  getCompostStats() {
    ...
    const avgCNRatio =
      completed.length > 0
        ? completed.reduce((sum, h) => sum + (h.c_n_ratio_achieved || 0), 0) / completed.length
        : 0;
