...
const DEFAULT_TOOL_REVIEWS = [
  { id: 'TRV-001', rental_id: 'TR-001', tool_id: 'TS-001', renter_farm_id: 'FARM-006', rating: 5, review_text: 'Excellent équipement, très fiable pour l\'arrosage. Le propriétaire est très professionnel.', would_rent_again: true, created_at: '2026-07-16T10:00:00.000Z' },
  { id: 'TRV-002', rental_id: 'TR-002', tool_id: 'TS-003', renter_farm_id: 'FARM-007', rating: 4, review_text: 'Bon pulvérisateur, mais aurait besoin d\'un entretien (buse légèrement obstruée).', would_rent_again: true, created_at: '2026-07-14T09:00:00.000Z' },
  { id: 'TRV-003', rental_id: 'TR-003', tool_id: 'TS-002', renter_farm_id: 'FARM-008', rating: 5, review_text: 'Charrette solide et bien entretenue. Parfaite pour le transport sur nos chemins de terre.', would_rent_again: true, created_at: '2026-07-11T08:00:00.000Z' }
];
